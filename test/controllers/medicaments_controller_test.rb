...
class MedicamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicament" do
    assert_difference("Medicament.count") do
      post medicaments_url, params: { medicament: { compound: @medicament.compound, name: @medicament.name, unit_id: @medicament.unit_id } }
    end
  ...
  test "should update medicament" do
    patch medicament_url(@medicament), params: { medicament: { compound: @medicament.compound, name: @medicament.name, unit_id: @medicament.unit_id } }
